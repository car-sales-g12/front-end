...
export const FormRegister = () => {
  ...
  const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (
    ...
    try {
      ...
      toast.error(
        "Falha ao cadastrar usuario revise os dados e tente novamente"
      );
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="div-is-seller">
        <Button active={!isSeller} onClick={toggleIsNotSeller}>
          Comprador
        </Button>
        <Button active={isSeller} onClick={toggleIsSeller}>
          Anunciante
        </Button>
      </div>
